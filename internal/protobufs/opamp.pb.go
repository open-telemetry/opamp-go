...
type DataForAgent_Flags int32

const (
	DataForAgent_FlagsUnspecified DataForAgent_Flags = 0
	// The server asks the agent to report effective config.
	DataForAgent_ReportEffectiveConfig DataForAgent_Flags = 1
	// The server asks the agent to report addon statuses.
	DataForAgent_ReportAddonStatus DataForAgent_Flags = 2
)

// Enum value maps for DataForAgent_Flags.
var (
	DataForAgent_Flags_name = map[int32]string{
		0: "FlagsUnspecified",
		1: "ReportEffectiveConfig",
		2: "ReportAddonStatus",
	}
	DataForAgent_Flags_value = map[string]int32{
		"FlagsUnspecified":      0,
...
func (x DataForAgent_Flags) Enum() *DataForAgent_Flags {
	p := new(DataForAgent_Flags)
	*p = x
	return p
}

func (x DataForAgent_Flags) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DataForAgent_Flags) Descriptor() protoreflect.EnumDescriptor {
	return file_opamp_proto_enumTypes[0].Descriptor()
}

func (DataForAgent_Flags) Type() protoreflect.EnumType {
	return &file_opamp_proto_enumTypes[0]
}

func (x DataForAgent_Flags) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DataForAgent_Flags.Descriptor instead.
func (DataForAgent_Flags) EnumDescriptor() ([]byte, []int) {
...
func (ConnectionSettings_Flags) EnumDescriptor() ([]byte, []int) {
	return file_opamp_proto_rawDescGZIP(), []int{4, 0}
}
...
const (
	...
	StatusReport_HealthUnset StatusReport_HealthStatus = 0
	// The agent is healthy.
	StatusReport_Healthy StatusReport_HealthStatus = 1
	// The agent is unhealthy.
	StatusReport_Unhealthy StatusReport_HealthStatus = 2
)

// Enum value maps for StatusReport_HealthStatus.
var (
	StatusReport_HealthStatus_name = map[int32]string{
		0: "HealthUnset",
		1: "Healthy",
		2: "Unhealthy",
	}
	StatusReport_HealthStatus_value = map[string]int32{
		"HealthUnset": 0,
		"Healthy":     1,
		"Unhealthy":   2,
	}
...
func (x StatusReport_HealthStatus) Enum() *StatusReport_HealthStatus {
	p := new(StatusReport_HealthStatus)
	*p = x
	return p
}
...
func (StatusReport_HealthStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_opamp_proto_enumTypes[3].Descriptor()
}

func (StatusReport_HealthStatus) Type() protoreflect.EnumType {
	return &file_opamp_proto_enumTypes[3]
}

func (x StatusReport_HealthStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use StatusReport_HealthStatus.Descriptor instead.
...
func (AgentInstallStatus_Status) EnumDescriptor() ([]byte, []int) {
	return file_opamp_proto_rawDescGZIP(), []int{22, 0}
}
...
type AgentToServer struct {
	...
	//	*AgentToServer_AddonStatuses
	//	*AgentToServer_AgentInstallStatus
	//	*AgentToServer_AgentDisconnect
...
func (x *AgentToServer) GetStatusReport() *StatusReport {
	if x, ok := x.GetBody().(*AgentToServer_StatusReport); ok {
...
func (x *AgentToServer) GetAddonStatuses() *AgentAddonStatuses {
	if x, ok := x.GetBody().(*AgentToServer_AddonStatuses); ok {
...
func (x *AgentToServer) GetAgentInstallStatus() *AgentInstallStatus {
	if x, ok := x.GetBody().(*AgentToServer_AgentInstallStatus); ok {
...
func (x *AgentToServer) GetAgentDisconnect() *AgentDisconnect {
	if x, ok := x.GetBody().(*AgentToServer_AgentDisconnect); ok {
...
type AgentToServer_AddonStatuses struct {
	...
	AddonStatuses *AgentAddonStatuses `protobuf:"bytes,3,opt,name=addon_statuses,json=addonStatuses,proto3,oneof"`
}

type AgentToServer_AgentInstallStatus struct {
	...
	AgentInstallStatus *AgentInstallStatus `protobuf:"bytes,4,opt,name=agent_install_status,json=agentInstallStatus,proto3,oneof"`
}

type AgentToServer_AgentDisconnect struct {
	AgentDisconnect *AgentDisconnect `protobuf:"bytes,5,opt,name=agent_disconnect,json=agentDisconnect,proto3,oneof"`
}

func (*AgentToServer_StatusReport) isAgentToServer_Body() {}

func (*AgentToServer_AddonStatuses) isAgentToServer_Body() {}

func (*AgentToServer_AgentInstallStatus) isAgentToServer_Body() {}

func (*AgentToServer_AgentDisconnect) isAgentToServer_Body() {}
...
type ServerToAgent struct {
	...
	InstanceUid string `protobuf:"bytes,1,opt,name=instance_uid,json=instanceUid,proto3" json:"instance_uid,omitempty"`
	// Types that are assignable to Body:
	//	*ServerToAgent_DataForAgent
	//	*ServerToAgent_ErrorResponse
...
func (x *ServerToAgent) GetDataForAgent() *DataForAgent {
	if x, ok := x.GetBody().(*ServerToAgent_DataForAgent); ok {
		return x.DataForAgent
	}
	return nil
}

func (x *ServerToAgent) GetErrorResponse() *ServerErrorResponse {
	if x, ok := x.GetBody().(*ServerToAgent_ErrorResponse); ok {
...
type ServerToAgent_DataForAgent struct {
	DataForAgent *DataForAgent `protobuf:"bytes,2,opt,name=data_for_agent,json=dataForAgent,proto3,oneof"`
}

type ServerToAgent_ErrorResponse struct {
	ErrorResponse *ServerErrorResponse `protobuf:"bytes,3,opt,name=error_response,json=errorResponse,proto3,oneof"`
}

func (*ServerToAgent_DataForAgent) isServerToAgent_Body() {}

func (*ServerToAgent_ErrorResponse) isServerToAgent_Body() {}
...
// of receipt).
type DataForAgent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// remote_config field is set when the server has a remote config offer for the agent.
	RemoteConfig *AgentRemoteConfig `protobuf:"bytes,1,opt,name=remote_config,json=remoteConfig,proto3" json:"remote_config,omitempty"`
	...
	ConnectionSettings *ConnectionSettingsOffers `protobuf:"bytes,2,opt,name=connection_settings,json=connectionSettings,proto3" json:"connection_settings,omitempty"`
	// addons_available field is set when the server has addons to offer to the agent.
	AddonsAvailable *AddonsAvailable `protobuf:"bytes,3,opt,name=addons_available,json=addonsAvailable,proto3" json:"addons_available,omitempty"`
	// agent_package_available field is set when the server has a different version
	// of an agent package available for download.
	AgentPackageAvailable *AgentPackageAvailable `protobuf:"bytes,4,opt,name=agent_package_available,json=agentPackageAvailable,proto3" json:"agent_package_available,omitempty"`
	// Bit flags as defined by Flags bit masks.
	Flags DataForAgent_Flags `protobuf:"varint,5,opt,name=flags,proto3,enum=opamp.proto.DataForAgent_Flags" json:"flags,omitempty"`
}

func (x *DataForAgent) Reset() {
	*x = DataForAgent{}
	if protoimpl.UnsafeEnabled {
...
func (x *DataForAgent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DataForAgent) ProtoMessage() {}

func (x *DataForAgent) ProtoReflect() protoreflect.Message {
	mi := &file_opamp_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DataForAgent.ProtoReflect.Descriptor instead.
func (*DataForAgent) Descriptor() ([]byte, []int) {
	return file_opamp_proto_rawDescGZIP(), []int{3}
}

func (x *DataForAgent) GetRemoteConfig() *AgentRemoteConfig {
	if x != nil {
...
func (x *DataForAgent) GetConnectionSettings() *ConnectionSettingsOffers {
	if x != nil {
...
func (x *DataForAgent) GetAddonsAvailable() *AddonsAvailable {
	if x != nil {
...
func (x *DataForAgent) GetAgentPackageAvailable() *AgentPackageAvailable {
	if x != nil {
...
func (x *DataForAgent) GetFlags() DataForAgent_Flags {
	if x != nil {
		return x.Flags
	}
	return DataForAgent_FlagsUnspecified
}
...
type AddonAvailable struct {
	...
	// The list of files in the addon.
	Files *DownloadableFileList `protobuf:"bytes,1,opt,name=files,proto3" json:"files,omitempty"`
	// The aggregate hash of the addon. SHOULD be calculated based on file names
	// and content of all files in the addon.
...
func (x *AddonAvailable) GetFiles() *DownloadableFileList {
	if x != nil {
		return x.Files
	}
	return nil
...
// of each individual file is provided so that the downloading can be skipped if the
// Agent already has the collection or the individual files.
type DownloadableFileList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Map of files. Keys are file names.
	Files map[string]*DownloadableFile `protobuf:"bytes,1,rep,name=files,proto3" json:"files,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// The aggregate hash of the list. SHOULD be calculated based on the names
	// and content of all files.
	Hash []byte `protobuf:"bytes,2,opt,name=hash,proto3" json:"hash,omitempty"`
}

func (x *DownloadableFileList) Reset() {
	*x = DownloadableFileList{}
	if protoimpl.UnsafeEnabled {
...
func (x *DownloadableFileList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DownloadableFileList) ProtoMessage() {}

func (x *DownloadableFileList) ProtoReflect() protoreflect.Message {
	mi := &file_opamp_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DownloadableFileList.ProtoReflect.Descriptor instead.
func (*DownloadableFileList) Descriptor() ([]byte, []int) {
	return file_opamp_proto_rawDescGZIP(), []int{11}
}

func (x *DownloadableFileList) GetFiles() map[string]*DownloadableFile {
	if x != nil {
		return x.Files
	}
	return nil
...
func (x *DownloadableFileList) GetHash() []byte {
	if x != nil {
		return x.Hash
	}
	return nil
...
func (x *DownloadableFile) GetHash() []byte {
	if x != nil {
		return x.Hash
	}
	return nil
...
type AgentPackageAvailable struct {
	...
	Files *DownloadableFileList `protobuf:"bytes,2,opt,name=files,proto3" json:"files,omitempty"`
}
...
func (x *AgentPackageAvailable) GetFiles() *DownloadableFileList {
	if x != nil {
		return x.Files
	}
	return nil
...
type StatusReport struct {
	...
	ServerProvidedAllAddonsHash []byte                    `protobuf:"bytes,4,opt,name=server_provided_all_addons_hash,json=serverProvidedAllAddonsHash,proto3" json:"server_provided_all_addons_hash,omitempty"`
	HealthStatus                StatusReport_HealthStatus `protobuf:"varint,5,opt,name=health_status,json=healthStatus,proto3,enum=opamp.proto.StatusReport_HealthStatus" json:"health_status,omitempty"`
}
...
func (x *StatusReport) GetServerProvidedAllAddonsHash() []byte {
	if x != nil {
...
func (x *StatusReport) GetHealthStatus() StatusReport_HealthStatus {
	if x != nil {
		return x.HealthStatus
	}
	return StatusReport_HealthUnset
}
...
var file_opamp_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe6, 0x02, 0x0a, 0x0d, 0x41,
	...
	0x40, 0x0a, 0x0d, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5f, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74,
	...
	,
	...
	0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x55, 0x69, 0x64, 0x12, 0x41, 0x0a, 0x0e, 0x64,
	0x61, 0x74, 0x61, 0x5f, 0x66, 0x6f, 0x72, 0x5f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6f, 0x70, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x46, 0x6f, 0x72, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x48, 0x00,
	0x52, 0x0c, 0x64, 0x61, 0x74, 0x61, 0x46, 0x6f, 0x72, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x12, 0x49,
	0x0a, 0x0e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x6f, 0x70, 0x61, 0x6d, 0x70, 0x2e, 0x70,
	...
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x42, 0x6f, 0x64,
	0x79, 0x22, 0xd8, 0x03, 0x0a, 0x0c, 0x44, 0x61, 0x74, 0x61, 0x46, 0x6f, 0x72, 0x41, 0x67, 0x65,
	0x6e, 0x74, 0x12, 0x43, 0x0a, 0x0d, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x5f, 0x63, 0x6f, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	0x75, 0x65, 0x22, 0x74, 0x0a, 0x0e, 0x54, 0x4c, 0x53, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69,
	0x63, 0x61, 0x74, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x6b,
	...
	0x65, 0x4b, 0x65, 0x79, 0x12, 0x22, 0x0a, 0x0d, 0x63, 0x61, 0x5f, 0x70, 0x75, 0x62, 0x6c, 0x69,
	0x63, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x63, 0x61, 0x50,
	0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x22, 0xf3, 0x03, 0x0a, 0x18, 0x43, 0x6f, 0x6e,
	...
	0x01, 0x28, 0x0c, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x12, 0x35, 0x0a, 0x05, 0x6f, 0x70, 0x61,
	0x6d, 0x70, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x6f, 0x70, 0x61, 0x6d, 0x70,
	...
	0x12, 0x40, 0x0a, 0x0b, 0x6f, 0x77, 0x6e, 0x5f, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x6f, 0x70, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72,
	...
	,
	...
	0x2e, 0x4f, 0x74, 0x68, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x10, 0x6f, 0x74, 0x68, 0x65, 0x72, 0x43, 0x6f, 0x6e,
	0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x64, 0x0a, 0x15, 0x4f, 0x74, 0x68, 0x65,
	...
	,
	...
	,
	...
	0x68, 0x61, 0x73, 0x68, 0x1a, 0x57, 0x0a, 0x0a, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x45, 0x6e, 0x74,
	...
	0x6c, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x49, 0x0a,
	0x10, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x61, 0x62, 0x6c, 0x65, 0x46, 0x69, 0x6c,
	...
	0x64, 0x55, 0x72, 0x6c, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x61, 0x73, 0x68, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x22, 0xef, 0x01, 0x0a, 0x13, 0x53, 0x65, 0x72,
	...
	0x12, 0x37, 0x0a, 0x0a, 0x72, 0x65, 0x74, 0x72, 0x79, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6f, 0x70, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2e, 0x52, 0x65, 0x74, 0x72, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x48, 0x00, 0x52, 0x09,
	0x72, 0x65, 0x74, 0x72, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x34, 0x0a, 0x04, 0x54, 0x79, 0x70,
	0x65, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x6e, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x10, 0x00, 0x12, 0x0e,
	0x0a, 0x0a, 0x42, 0x61, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x10, 0x01, 0x12, 0x0f,
	0x0a, 0x0b, 0x55, 0x6e, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x10, 0x02, 0x42,
	...
	0x6a, 0x0a, 0x15, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x41,
	0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x12, 0x37, 0x0a, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x22, 0x98, 0x01, 0x0a, 0x10,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x12, 0x40, 0x0a, 0x10, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x5f, 0x61, 0x74,
	0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15,
	0x2e, 0x6f, 0x70, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4b, 0x65, 0x79,
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x0f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x41, 0x74, 0x74, 0x72,
	0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x22, 0xc6, 0x03, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x4a, 0x0a, 0x11, 0x61, 0x67, 0x65, 0x6e, 0x74,
	...
	,
	...
	0x61, 0x70, 0x22, 0xe1, 0x01, 0x0a, 0x12, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x35, 0x0a, 0x17, 0x6c, 0x61, 0x73,
	0x74, 0x5f, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f,
	0x68, 0x61, 0x73, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x14, 0x6c, 0x61, 0x73, 0x74,
	0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x61, 0x73, 0x68,
	0x12, 0x3e, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x26, 0x2e, 0x6f, 0x70, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x52,
	...
	,
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x41, 0x64, 0x64, 0x6f,
	0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02,
	0x38, 0x01, 0x22, 0xaf, 0x02, 0x0a, 0x10, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x41, 0x64, 0x64, 0x6f,
	...
	0x67, 0x65, 0x6e, 0x74, 0x5f, 0x68, 0x61, 0x73, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x0c, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x48, 0x61, 0x73, 0x48, 0x61, 0x73,
	0x68, 0x12, 0x2e, 0x0a, 0x13, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x6f, 0x66, 0x66, 0x65,
	0x72, 0x65, 0x64, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x11,
	...
	,
	...
	0x72, 0x65, 0x64, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x11,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4f, 0x66, 0x66, 0x65, 0x72, 0x65, 0x64, 0x48, 0x61, 0x73,
	0x68, 0x12, 0x3e, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x26, 0x2e, 0x6f, 0x70, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e,
	0x41, 0x67, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x53, 0x74, 0x61, 0x74,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x53, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x11, 0x0a, 0x0d, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64,
	0x10, 0x02, 0x12, 0x17, 0x0a, 0x13, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x4e, 0x6f, 0x50,
	0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x10, 0x03, 0x22, 0x69, 0x0a, 0x11, 0x41,
	...
	0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x42, 0x37, 0x5a, 0x35, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6f, 0x70, 0x65, 0x6e, 0x2d, 0x74, 0x65,
	0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x2f, 0x6f, 0x70, 0x61, 0x6d, 0x70, 0x2d, 0x67, 0x6f,
...
var file_opamp_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_opamp_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_opamp_proto_goTypes = []interface{}{
	(DataForAgent_Flags)(0),          // 0: opamp.proto.DataForAgent.Flags
	(ConnectionSettings_Flags)(0),    // 1: opamp.proto.ConnectionSettings.Flags
	(ServerErrorResponse_Type)(0),    // 2: opamp.proto.ServerErrorResponse.Type
	(StatusReport_HealthStatus)(0),   // 3: opamp.proto.StatusReport.HealthStatus
	(RemoteConfigStatus_Status)(0),   // 4: opamp.proto.RemoteConfigStatus.Status
	(AgentAddonStatus_Status)(0),     // 5: opamp.proto.AgentAddonStatus.Status
	(AgentInstallStatus_Status)(0),   // 6: opamp.proto.AgentInstallStatus.Status
	(*AgentToServer)(nil),            // 7: opamp.proto.AgentToServer
	(*AgentDisconnect)(nil),          // 8: opamp.proto.AgentDisconnect
	(*ServerToAgent)(nil),            // 9: opamp.proto.ServerToAgent
	(*DataForAgent)(nil),             // 10: opamp.proto.DataForAgent
	...
	(*DownloadableFileList)(nil),     // 18: opamp.proto.DownloadableFileList
	(*DownloadableFile)(nil),         // 19: opamp.proto.DownloadableFile
	(*ServerErrorResponse)(nil),      // 20: opamp.proto.ServerErrorResponse
	(*RetryInfo)(nil),                // 21: opamp.proto.RetryInfo
	(*AgentPackageAvailable)(nil),    // 22: opamp.proto.AgentPackageAvailable
	(*AgentDescription)(nil),         // 23: opamp.proto.AgentDescription
	(*StatusReport)(nil),             // 24: opamp.proto.StatusReport
	(*EffectiveConfig)(nil),          // 25: opamp.proto.EffectiveConfig
	(*RemoteConfigStatus)(nil),       // 26: opamp.proto.RemoteConfigStatus
	(*AgentAddonStatuses)(nil),       // 27: opamp.proto.AgentAddonStatuses
	(*AgentAddonStatus)(nil),         // 28: opamp.proto.AgentAddonStatus
	(*AgentInstallStatus)(nil),       // 29: opamp.proto.AgentInstallStatus
	(*AgentRemoteConfig)(nil),        // 30: opamp.proto.AgentRemoteConfig
	(*AgentConfigMap)(nil),           // 31: opamp.proto.AgentConfigMap
	(*AgentConfigFile)(nil),          // 32: opamp.proto.AgentConfigFile
	nil,                              // 33: opamp.proto.ConnectionSettingsOffers.OtherConnectionsEntry
	nil,                              // 34: opamp.proto.AddonsAvailable.AddonsEntry
	nil,                              // 35: opamp.proto.DownloadableFileList.FilesEntry
	nil,                              // 36: opamp.proto.AgentAddonStatuses.AddonsEntry
	nil,                              // 37: opamp.proto.AgentConfigMap.ConfigMapEntry
	(*KeyValue)(nil),                 // 38: opamp.proto.KeyValue
}
var file_opamp_proto_depIdxs = []int32{
	24, // 0: opamp.proto.AgentToServer.status_report:type_name -> opamp.proto.StatusReport
	27, // 1: opamp.proto.AgentToServer.addon_statuses:type_name -> opamp.proto.AgentAddonStatuses
	29, // 2: opamp.proto.AgentToServer.agent_install_status:type_name -> opamp.proto.AgentInstallStatus
	8,  // 3: opamp.proto.AgentToServer.agent_disconnect:type_name -> opamp.proto.AgentDisconnect
	10, // 4: opamp.proto.ServerToAgent.data_for_agent:type_name -> opamp.proto.DataForAgent
	20, // 5: opamp.proto.ServerToAgent.error_response:type_name -> opamp.proto.ServerErrorResponse
	30, // 6: opamp.proto.DataForAgent.remote_config:type_name -> opamp.proto.AgentRemoteConfig
	15, // 7: opamp.proto.DataForAgent.connection_settings:type_name -> opamp.proto.ConnectionSettingsOffers
	16, // 8: opamp.proto.DataForAgent.addons_available:type_name -> opamp.proto.AddonsAvailable
	22, // 9: opamp.proto.DataForAgent.agent_package_available:type_name -> opamp.proto.AgentPackageAvailable
	0,  // 10: opamp.proto.DataForAgent.flags:type_name -> opamp.proto.DataForAgent.Flags
	...
	1,  // 14: opamp.proto.ConnectionSettings.flags:type_name -> opamp.proto.ConnectionSettings.Flags
	...
	33, // 20: opamp.proto.ConnectionSettingsOffers.other_connections:type_name -> opamp.proto.ConnectionSettingsOffers.OtherConnectionsEntry
	34, // 21: opamp.proto.AddonsAvailable.addons:type_name -> opamp.proto.AddonsAvailable.AddonsEntry
	18, // 22: opamp.proto.AddonAvailable.files:type_name -> opamp.proto.DownloadableFileList
	35, // 23: opamp.proto.DownloadableFileList.files:type_name -> opamp.proto.DownloadableFileList.FilesEntry
	2,  // 24: opamp.proto.ServerErrorResponse.type:type_name -> opamp.proto.ServerErrorResponse.Type
	21, // 25: opamp.proto.ServerErrorResponse.retry_info:type_name -> opamp.proto.RetryInfo
	18, // 26: opamp.proto.AgentPackageAvailable.files:type_name -> opamp.proto.DownloadableFileList
	38, // 27: opamp.proto.AgentDescription.agent_attributes:type_name -> opamp.proto.KeyValue
	23, // 28: opamp.proto.StatusReport.agent_description:type_name -> opamp.proto.AgentDescription
	25, // 29: opamp.proto.StatusReport.effective_config:type_name -> opamp.proto.EffectiveConfig
	26, // 30: opamp.proto.StatusReport.remote_config_status:type_name -> opamp.proto.RemoteConfigStatus
	3,  // 31: opamp.proto.StatusReport.health_status:type_name -> opamp.proto.StatusReport.HealthStatus
	31, // 32: opamp.proto.EffectiveConfig.config_map:type_name -> opamp.proto.AgentConfigMap
	4,  // 33: opamp.proto.RemoteConfigStatus.status:type_name -> opamp.proto.RemoteConfigStatus.Status
	36, // 34: opamp.proto.AgentAddonStatuses.addons:type_name -> opamp.proto.AgentAddonStatuses.AddonsEntry
	5,  // 35: opamp.proto.AgentAddonStatus.status:type_name -> opamp.proto.AgentAddonStatus.Status
	6,  // 36: opamp.proto.AgentInstallStatus.status:type_name -> opamp.proto.AgentInstallStatus.Status
	31, // 37: opamp.proto.AgentRemoteConfig.config:type_name -> opamp.proto.AgentConfigMap
	37, // 38: opamp.proto.AgentConfigMap.config_map:type_name -> opamp.proto.AgentConfigMap.ConfigMapEntry
	11, // 39: opamp.proto.ConnectionSettingsOffers.OtherConnectionsEntry.value:type_name -> opamp.proto.ConnectionSettings
	17, // 40: opamp.proto.AddonsAvailable.AddonsEntry.value:type_name -> opamp.proto.AddonAvailable
	19, // 41: opamp.proto.DownloadableFileList.FilesEntry.value:type_name -> opamp.proto.DownloadableFile
	28, // 42: opamp.proto.AgentAddonStatuses.AddonsEntry.value:type_name -> opamp.proto.AgentAddonStatus
	32, // 43: opamp.proto.AgentConfigMap.ConfigMapEntry.value:type_name -> opamp.proto.AgentConfigFile
...
func file_opamp_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_opamp_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DownloadableFileList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_opamp_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*AgentToServer_StatusReport)(nil),
		(*AgentToServer_AddonStatuses)(nil),
		(*AgentToServer_AgentInstallStatus)(nil),
		(*AgentToServer_AgentDisconnect)(nil),
	}
	file_opamp_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*ServerToAgent_DataForAgent)(nil),
		(*ServerToAgent_ErrorResponse)(nil),
	}
